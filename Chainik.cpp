...
// Chainik.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CChainikApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CChainikApp

CChainikApp::CChainikApp()
{
...
// Единственный объект CChainikApp

CChainikApp theApp;


// Инициализация CChainikApp

BOOL CChainikApp::InitInstance()
{
